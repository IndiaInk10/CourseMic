...
import 'package:capston/chat/models/chat_user.dart';

class SearchChatPage extends StatefulWidget {
  final ChatListPageState chatListParent;
  const SearchChatPage({super.key, required this.chatListParent});
...
class _SearchChatPageState extends State<SearchChatPage> {
  ...
  void searchChatPage(String shortRoomCode) async {
